...
// ─── Mock event detail (backend offline fallback) ─────────────────────────────
...
const MOCK_DETAILS = {
  "1": {
    ...
    geography: ["Yemen", "Red Sea", "Gulf of Aden"], importance_score: 91,
    consequence_map: {
      consequence_chain: [
        ...
        { type: "INFERRED MECHANISM", content: "Just-in-time manufacturing systems in Europe and North America face parts shortages as delivery windows shift." },
        { type: "SPECULATIVE EFFECT", content: "Prolonged disruption could trigger inflationary pressure on consumer goods if rerouting persists beyond Q2." },
      ],
      ...
      indirect_impact: [{ sector: "Consumer Prices",      severity: "MODERATE", description: "6-9% increase in imported goods costs projected for EU and US markets over 6 months." }],
      predictions: [
    ...
    articles: [
      ...
      { source: "BBC",       title: "Why the Houthi attacks are disrupting world trade",                       url: "#", date: "2024-01-12" },
    ],
  },
  "3": {
    ...
    canonical_summary: "PLA Eastern Theater Command conducted live-fire drills encircling Taiwan. Semiconductor supply chains at risk.",
    geography: ["Taiwan", "China", "South China Sea"], importance_score: 89,
    consequence_map: {
      consequence_chain: [
        { type: "VERIFIED FACT",      content: "PLA conducted its largest Taiwan encirclement drills since 1996, involving carrier battle groups, missile strikes, and electronic warfare." },
        { type: "INFERRED MECHANISM", content: "TSMC accounts for 92% of advanced chips below 5nm globally — any conflict scenario triggers immediate supply disruption." },
        { type: "SPECULATIVE EFFECT", content: "Global AI and consumer electronics production halt within 3-6 months if TSMC fab access is disrupted." },
      ],
      direct_impact:   [{ sector: "Semiconductor Supply", severity: "CRITICAL", description: "TSMC fabs produce 92% of advanced logic chips. Scenario modeling shows complete stoppage within weeks of escalation." }],
      indirect_impact: [{ sector: "Tech Industry",        severity: "HIGH",     description: "Apple, NVIDIA, AMD would exhaust chip inventories within 4-6 months." }],
      predictions: [
        { label: "De-escalation",    confidence: 45 },
        { label: "Continued Drills", confidence: 40 },
        { label: "Kinetic Conflict", confidence: 15 },
      ],
    },
    articles: [
      { source: "Reuters",           title: "China's military drills around Taiwan signal new normal in strait tensions", url: "#", date: "2024-01-18" },
      { source: "Financial Times",   title: "TSMC's Taiwan exposure puts tech world on edge as China tensions rise",      url: "#", date: "2024-01-17" },
    ],
  },
};

function getMockEvent(eventId) {
  if (MOCK_DETAILS[eventId]) return MOCK_DETAILS[eventId];
  return {
    ...
    consequence_map: {
      ...
      direct_impact:   [{ sector: "Analysis Pending", severity: "MODERATE", description: "Live AI consequence chain requires backend connection." }],
      indirect_impact: [],
