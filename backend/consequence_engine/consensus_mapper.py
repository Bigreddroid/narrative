"""
LEAN / STRETCH — consequence mapping.
Basic mapping only for terminal impact lens.
Full Claude chain + evidence is stretch (enterprise).
Use lightly or skip for lean MVP.
"""
