...
async def main():
    ...
    from backend.workers.external_resolution_worker import run_external_resolution_worker
    ...
    tasks = [
        ...
        asyncio.create_task(
            _run_with_interval("external_resolution_worker", run_external_resolution_worker,
                               s.external_resolution_interval_hours * 3600)
        ),
        asyncio.create_task(
