"""
DEPRECATED / LEGACY dev server.
Use the real backend instead:
  uvicorn backend.main:app --reload --port 8000
  (or docker-compose up for full stack with Postgres/Redis)

This file exists only for isolated frontend mocking during early UI work.
It will be removed once the mobile + web clients are reliably talking to the real API.
"""
